    ...
    <SiteLayout>
      <div className="min-h-screen bg-black">
        ...
        <div className="fixed inset-0 z-0">
          <Image
            src="/images/astrophotography/deep-sky/nebulas/Heart and Soul Nebulas-4.jpg"
            alt={scope.title}
            fill
                ...
                >
                  <div className="relative bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 overflow-hidden shadow-2xl hover:bg-white/10 hover:border-white/20 transition-all duration-300 w-72 h-72">
                    <div className="absolute inset-0">
                      <Image
                        src={scope.categoryImages?.[cat.slug as keyof typeof scope.categoryImages] || scope.backgroundImage}
                        alt={cat.title}
                        fill
