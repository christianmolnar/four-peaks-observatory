...
export const metadata: Metadata = generateSolarSystemMetadata(
  'solar',
  'Solar Photography',
  'High-resolution solar photography capturing sunspots, solar flares, and surface details of our nearest star. Specialized solar imaging techniques and equipment showcased from Four Peaks Observatory.',
