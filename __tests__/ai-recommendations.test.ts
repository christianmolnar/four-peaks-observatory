...
describe('AI Recommendations', () => {
  ...
  const mockCriteria = {
    ...
    seeing: { observationType: 'balanced' },
    moonPhase: { goodPhases: ['new'], dubiousPhases: ['quarter'], poorPhases: ['full'] },
    cloudCover: { excellent: { threshold: 10 }, good: { threshold: 25 } },
    transparency: { excellent: ['above_average'], good: ['average'] }
  };
